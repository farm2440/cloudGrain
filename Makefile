...
# Generated by qmake (2.01a) (Qt 4.6.3) on: ?? ??. 18 11:09:23 2015
...
INCPATH       = -I/new_disk/Hiteg/qt/build/mkspecs/qws/linux-arm-g++ -I. -I/new_disk/Hiteg/qt/build/include/QtCore -I/new_disk/Hiteg/qt/build/include/QtNetwork -I/new_disk/Hiteg/qt/build/include/QtXml -I/new_disk/Hiteg/qt/build/include -Iqserialdevice/src -I.
LINK          = arm-linux-g++
LFLAGS        = -Wl,-rpath,/new_disk/Hiteg/qt/build/lib
LIBS          = $(SUBLIBS)  -L./qserialdevice/src/release -L/new_disk/Hiteg/qt/build//lib -lqserialdevice -lQtXml -L/new_disk/Hiteg/qt/build//lib -lQtNetwork -lQtCore -lpthread 
AR            = arm-linux-ar cqs
RANLIB        = 
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/cloudGrain1.0.0/ && $(COPY_FILE) --parents definitions.h worker.h .tmp/cloudGrain1.0.0/ && $(COPY_FILE) --parents main.cpp worker.cpp .tmp/cloudGrain1.0.0/ && (cd `dirname .tmp/cloudGrain1.0.0` && $(TAR) cloudGrain1.0.0.tar cloudGrain1.0.0 && $(COMPRESS) cloudGrain1.0.0.tar) && $(MOVE) `dirname .tmp/cloudGrain1.0.0`/cloudGrain1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/cloudGrain1.0.0
...
compiler_moc_header_make_all: moc_worker.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_worker.cpp
moc_worker.cpp: definitions.h \
		worker.h
